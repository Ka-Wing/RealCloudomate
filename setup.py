...
if len(options_) > 1:
    if options_[1] == 'install':
        ...
        test_ = os.popen('apt-get install libssl-dev ').read()
        print(test_)
        test_ = os.popen('apt-get install build-essential').read()
        print(test_)
        test_ = os.popen('apt-get install automake').read()
        print(test_)
        test_ = os.popen('apt-get install pkg-config').read()
        print(test_)
        test_ = os.popen('apt-get install libtool').read()
        print(test_)
        test_ = os.popen('apt-get install libffi-dev').read()
        print(test_)
        test_ = os.popen('apt-get install libgmp-dev').read()
        print(test_)
        test_ = os.popen('apt-get install libyaml-cpp-dev').read()
        print(test_)
